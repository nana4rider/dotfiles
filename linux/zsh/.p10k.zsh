# Generated by Powerlevel10k configuration wizard on 2025-02-06 at 05:43 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=$(cat ~/.contextcolor)
